<?
	...
	$leftMenu = array(
		array('title'=>'Домой', 'href'=>'index.php'),
		array('title'=>'О нас', 'href'=>'about.php'),
		array('title'=>'Контакты', 'href'=>'contact.php'),
		array('title'=>'Таблица умножения', 'href'=>'/lesson05/table.php'),
		array('title'=>'Калькулятор', 'href'=>'calc.php'),
	);
?>
<!DOCTYPE html>
                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            <ul class="nav navbar-nav navbar-nav-right">
								<?
									foreach($leftMenu as $array){?>
									<li class='js_nav-item nav-item'><a class='nav-item-child nav-item-hover' href='<? echo $array['href']?>'><? echo $array['title']?></a></li><? }
								?>
                            </ul>
                        </div>
                    </div>
